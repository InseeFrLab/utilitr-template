...
#       ..., extra_dependencies = c(bookdown:::gitbook_dependency(table_css), extra_dependencies)
#     )
#   }
#   gb_config = config
#   if (identical(template, 'default')) {
#     template = bookdown_file:::bookdown_file('templates', 'gitbook.html')
#   }
...
#   list(bookdown:::jquery_dependency(), htmltools::htmlDependency(
