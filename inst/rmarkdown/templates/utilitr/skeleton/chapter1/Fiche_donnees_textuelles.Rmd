...
* L'expression régulière `"([0-9]{2}\\.*){5}"` permet de rechecher cinq séries de deux chiffres éventuellement séparées par un point. Exemple : `str_detect("12.12.12.12.12.", pattern = "([0-9]{2}\\.*){5}")`.
...
- [Partie `stringr`](https://juba.github.io/tidyverse/11-stringr.html) de l'introduction à `R` et au `tidyverse` ;
- [Vignette](https://github.com/tidyverse/stringr/blob/master/vignettes/from-base.Rmd) comparant `stringr` et `base R`.
